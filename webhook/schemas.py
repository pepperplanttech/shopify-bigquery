...
class Money(BaseModel):
    """Represents a money amount with currency code."""
    amount: str = Field(..., description="The money amount as a string.")
    currency_code: str = Field(..., description="The three-letter currency code (e.g., 'USD').")

class PriceSet(BaseModel):
    """A pair of shop and presentment money objects."""
    shop_money: Money
